...
public class MainPanel extends JPanel {
    ...
    /** ***Previous code
     *  Makes a string of 1000 0s, adds value of x, converts string with 1000 0's plus x to int, returns int (which is just x)
    	...
    	return q;
    */
    	//Refactored code keeps the only relevant part: return value passed in
    	return x;
    }
